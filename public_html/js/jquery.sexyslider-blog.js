...
**/
  ...
  transition: function(dir) {
    ...
    if (this.titles[this.imgInc]!='')
    {
      $(this.dom.title).animate({ 'opacity' : 0 }, this.options.titleSpeed, $.proxy(function() { $(this.dom.title).html(this.titles[this.imgInc]);  Cufon.replace('.blog-slider .navigation .intro a', { fontFamily: 'Prima', hover: 'true', textShadow: '#850402 0 1px 0' } ); this.options.onTitleHide.call(this); }, this));
